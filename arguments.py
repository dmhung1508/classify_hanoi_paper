...
def load_args():
    ...
    parser.add_argument('--roberta_config', default='longformer/config.json')
    parser.add_argument('--roberta', default='longformer/pytorch_model.bin')
    parser.add_argument('--model_pretrained', default='longformer')
    parser.add_argument('--model_saved', default='longformer')
    ...
    parser.add_argument("--num_class", dest="num_class", type=int, default=2)
